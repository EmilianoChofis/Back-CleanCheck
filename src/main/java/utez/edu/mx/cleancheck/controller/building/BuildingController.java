...
public class BuildingController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ApiResponse<Building>> create(@Validated({BuildingDto.CreateBuilding.class}) @RequestBody BuildingDto building) {
        try {
    ...
    @PutMapping("/update")
    public ResponseEntity<ApiResponse<Building>> update(@Validated({BuildingDto.UpdateBuilding.class}) @RequestBody BuildingDto building) {
        try {
